    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-20 left-10 transform -rotate-12 opacity-20 lg:opacity-30">
          <PlayingCard suit="hearts" rank="K" width={120} height={168} className="lg:w-[180px] lg:h-[252px]" />
        </div>
        
        {/* Carte en haut à droite */}
        <div className="absolute top-32 right-10 transform rotate-12 opacity-20 lg:opacity-30">
          <PlayingCard suit="spades" rank="A" width={120} height={168} className="lg:w-[180px] lg:h-[252px]" />
        </div>
        ...
        <div className="absolute bottom-32 right-20 transform -rotate-6 opacity-20 lg:opacity-30">
          <PlayingCard suit="diamonds" rank="Q" width={120} height={168} className="lg:w-[180px] lg:h-[252px]" />
        </div>
        
        {/* Carte cachée sur mobile, visible sur desktop */}
        <div className="hidden lg:block absolute top-1/2 left-20 transform -rotate-45 opacity-20">
          <PlayingCard suit="clubs" rank="J" width={180} height={252} />
        </div>
      </div>

      {/* Effets de brillance */}
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-primary/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-primary/5 rounded-full blur-3xl animate-pulse" />

      {/* Particules flottantes */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-2 h-2 bg-primary/60 rounded-full animate-float-slow" />
        <div className="absolute top-2/3 right-1/3 w-3 h-3 bg-primary/40 rounded-full animate-float-medium" />
        <div className="absolute bottom-1/3 right-1/4 w-2 h-2 bg-primary/30 rounded-full animate-float-fast" />
      </div>
